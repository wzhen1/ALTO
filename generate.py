...
model.module.encoder.unet3d = nn.DataParallel(model.module.encoder.unet3d, device_ids=[0]) ### volume 3dcnn
# model.module.encoder.unet = nn.DataParallel(model.module.encoder.unet, device_ids=[0]) ### 3-plane
